...
non_public_schools_gdf = gpd.read_file('non_public_schools.geojson')
...
station_counts = joined_gdf.groupby('Name').size().reset_index(name='Non_public_schools_Count')

# Save the output to a CSV file
station_counts.to_csv('Non_public_schools.csv', index=False)
